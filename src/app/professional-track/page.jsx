    ...
    <div className="min-h-screen bg-gray-50 selection:bg-primary/20">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/studies-hero.png" alt="Professional Track" fill className="object-cover" priority />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold tracking-tight mb-6 leading-tight">
              Ayurvedic <span className="text-emerald-300 italic font-serif">Professional Track</span>
            </h1>
            <p className="text-lg lg:text-xl text-gray-200 mb-10 leading-relaxed font-light">
              Become an Ayurvedic Health Counselor or Practitioner. Turn your passion for well-being into a fulfilling, professional career.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6 tracking-tight">Become a Certified Expert</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6 font-light">
                Study with master practitioner Vasant Lad and an elite team of educators. We provide full-time, part-time, and hybrid formats explicitly designed to accommodate modern life.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed font-light mb-8">
                Gain clinical experience directly in our student clinics, participate in comprehensive panchakarma protocols, and master the art of pulse reading and herbal formulations.
              </p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="bg-gray-900 rounded-3xl p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
              ...
              <h2 className="text-2xl lg:text-3xl font-bold mb-8 relative z-10 flex items-center gap-3">
                <GraduationCap className="text-emerald-400" /> Career Pathways
              </h2>
              <ul className="space-y-6 relative z-10">
                {["Level 1: Ayurvedic Health Counselor (AHC)", "Level 2: Ayurvedic Practitioner (AP)", "Level 3: Advanced Practitioner (AAP)", "Extensive clinical internship and patient management."].map((benefit, index) => (
